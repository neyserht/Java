...
public class HelloController {
    ...
    protected void f1()
    {
        ...
        cervezasRubias1.put("aguila", 1.9);
        ...
        if (comboBox1.getValue().toString().equals(comboBox1.getItems().get(0).toString()))
        {
            ...
            String cervezas1[]=new String[cervezasRubias1.size()];
            int contador = 0;
            Iterator i = cervezasRubias1.keySet().iterator();
            while (i.hasNext())
            {
                String key = (String) i.next();
                cervezas1[contador] = key;
                contador++;
            }
            ...
            // Establecer el id del comboBox1 y comboBox2 al tipo de verveza añadido
            comboBox1.setId("cervezasRubias1");
            comboBox2.setId("cervezasRubias1");
